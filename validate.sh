...
expect_contains "grep -F 'cursor-agent | agent | fx | pi' \"$REPO_DIR/scripts/tmux-insert-paths.sh\"" "cursor-agent | agent | fx | pi" "agent detection with pi"
...
expect_contains "grep -F '\"title\": \"aichat Actions\"' \"$REPO_DIR/tmux-menu/config.json\"" "aichat Actions" "aichat submenu"
...
expect_contains "grep -F '\"title\": \"Antigravity - Open\"' \"$REPO_DIR/tmux-menu/config.json\"" "Antigravity - Open" "Antigravity agent menu entry"
expect_contains "grep -F '\"title\": \"Antigravity - Resume\"' \"$REPO_DIR/tmux-menu/config.json\"" "Antigravity - Resume" "Antigravity resume menu entry"
expect_contains "grep -F '\"title\": \"Claude - Open\"' \"$REPO_DIR/tmux-menu/config.json\"" "Claude - Open" "Claude agent menu entry"
expect_contains "grep -F '\"title\": \"Codex - Open\"' \"$REPO_DIR/tmux-menu/config.json\"" "Codex - Open" "Codex agent menu entry"
expect_contains "grep -F '\"title\": \"Codex - Resume\"' \"$REPO_DIR/tmux-menu/config.json\"" "Codex - Resume" "Codex resume menu entry"
expect_contains "grep -F '\"title\": \"Cursor - Open\"' \"$REPO_DIR/tmux-menu/config.json\"" "Cursor - Open" "Cursor agent menu entry"
expect_contains "grep -F '\"title\": \"fx - Open\"' \"$REPO_DIR/tmux-menu/config.json\"" "fx - Open" "fx agent menu entry"
expect_contains "grep -F '\"title\": \"fx - Resume\"' \"$REPO_DIR/tmux-menu/config.json\"" "fx - Resume" "fx resume menu entry"
expect_contains "grep -F '\"title\": \"Pi - Open\"' \"$REPO_DIR/tmux-menu/config.json\"" "Pi - Open" "Pi agent menu entry"
expect_contains "grep -F '\"title\": \"Pi - Resume\"' \"$REPO_DIR/tmux-menu/config.json\"" "Pi - Resume" "Pi resume menu entry"
...
expect_contains "grep -F 'launch-agent-pane.sh antigravity-resume' \"$REPO_DIR/tmux-menu/config.json\"" "launch-agent-pane.sh antigravity-resume" "Antigravity resume menu command"
expect_contains "grep -F 'launch-agent-pane.sh claude' \"$REPO_DIR/tmux-menu/config.json\"" "launch-agent-pane.sh claude" "Claude menu command"
...
expect_contains "grep -F 'launch-agent-pane.sh cursor-agent' \"$REPO_DIR/tmux-menu/config.json\"" "launch-agent-pane.sh cursor-agent" "Cursor Agent menu command"
expect_contains "grep -F 'launch-agent-pane.sh fx' \"$REPO_DIR/tmux-menu/config.json\"" "launch-agent-pane.sh fx" "fx menu command"
expect_contains "grep -F 'launch-agent-pane.sh fx-resume' \"$REPO_DIR/tmux-menu/config.json\"" "launch-agent-pane.sh fx-resume" "fx resume menu command"
expect_contains "grep -F 'launch-agent-pane.sh pi' \"$REPO_DIR/tmux-menu/config.json\"" "launch-agent-pane.sh pi" "Pi menu command"
expect_contains "grep -F 'launch-agent-pane.sh pi-resume' \"$REPO_DIR/tmux-menu/config.json\"" "launch-agent-pane.sh pi-resume" "Pi resume menu command"
expect_contains "grep -F 'claude|codex|codex-resume|cursor-agent' \"$REPO_DIR/scripts/launch-agent-pane.sh\"" "claude|codex|codex-resume|cursor-agent" "Claude and Cursor launch script usage"
expect_contains "grep -F 'agent_command=\"agy --continue\"' \"$REPO_DIR/scripts/launch-agent-pane.sh\"" "agent_command=\"agy --continue\"" "Antigravity resume command"
...
expect_contains "grep -F 'show-buffer' \"$REPO_DIR/tmux-omni/ai.go\"" "show-buffer" "AI latest-copy buffer read"
