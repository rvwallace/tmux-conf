...
expect_contains "grep -F '\"title\": \"AI: Open fx Agent\"' \"$REPO_DIR/tmux-menu/config.json\"" "AI: Open fx Agent" "fx agent menu entry"
expect_contains "grep -F '\"title\": \"AI: Resume fx Agent\"' \"$REPO_DIR/tmux-menu/config.json\"" "AI: Resume fx Agent" "fx resume menu entry"
expect_contains "grep -F '\"title\": \"AI: Open Pi Agent\"' \"$REPO_DIR/tmux-menu/config.json\"" "AI: Open Pi Agent" "Pi agent menu entry"
expect_contains "grep -F '\"title\": \"AI: Continue Pi Agent\"' \"$REPO_DIR/tmux-menu/config.json\"" "AI: Continue Pi Agent" "Pi continue menu entry"
expect_contains "grep -F '\"title\": \"AI: Resume Pi Agent\"' \"$REPO_DIR/tmux-menu/config.json\"" "AI: Resume Pi Agent" "Pi resume menu entry"
...
expect_contains "grep -F 'launch-agent-pane.sh pi-continue' \"$REPO_DIR/tmux-menu/config.json\"" "launch-agent-pane.sh pi-continue" "Pi continue menu command"
...
expect_contains "grep -F 'pi|pi-continue|pi-resume' \"$REPO_DIR/scripts/launch-agent-pane.sh\"" "pi|pi-continue|pi-resume" "Pi launch script usage"
